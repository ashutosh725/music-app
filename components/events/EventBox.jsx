...
<div className="flex-1  h-[500px] flex flex-col justify-between overflow-y-scroll scrollbar-thin scrollbar-thumb-accent scrollbar-track-white/10 xl:pr-6">
    {
        events.map((event)=>{
            ...
            return <div key={event.id} className="flex flex-col xl:flex-row justify-between items-center gap-y-4 xl:gap-y-0 text-center xl:text-left my-4 xl:my-0 border-b border-white/10 pb-10 xl:py-3 last-of-type:border-none first-of-type:pt-0">
                <div className="flex flex-col xl:flex-row items-center gap-x-4">
                    ...
                    <div className="flex flex-col justify-between items-center leading-tight w-[80px] mb-4 xl:mb-0 ">
                        <div className="text-[44px] font-black text-accent">{event.data.day}</div>
                        <div className="text-[20px]  font-extrabold">{event.data.month}</div>
                    </div>
                    <div className=" w-64 flex flex-col  gap-y-2">
                        <div className="text-lg leadi font-bold">{`${event.Location.city}, ${event.Location.country}`}</div>
                        <div className="flex items-center gap-x-1 justify-center ">
                            <div className="text-accent text-lg"><RiMapPin2Fill/></div>
